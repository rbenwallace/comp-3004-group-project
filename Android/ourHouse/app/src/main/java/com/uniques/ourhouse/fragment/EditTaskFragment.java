...
import com.uniques.ourhouse.controller.EditTaskCtrl;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

public class EditTaskFragment extends Fragment<EditTaskCtrl> {
    ...
    public static FragmentId setupId(ActivityId activityId) {
        return FragmentId.SET(EditTaskFragment.class, TAG, LAYOUT_ID, activityId);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (controller == null) {
            setController(new EditTaskCtrl(FragmentActivity.getSavedInstance(getFragmentId().getDefaultActivityId(), this)));
        }
