...
import com.uniques.ourhouse.controller.EditFeeCtrl;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

public class EditFeeFragment extends Fragment<EditFeeCtrl> {
    public static final String TAG = "EditFeeFragment";
    ...
    public static FragmentId setupId(ActivityId activityId) {
        return FragmentId.SET(EditFeeFragment.class, TAG, LAYOUT_ID, activityId);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (controller == null) {
            setController(new EditFeeCtrl(FragmentActivity.getSavedInstance(getFragmentId().getDefaultActivityId(), this)));
        }
